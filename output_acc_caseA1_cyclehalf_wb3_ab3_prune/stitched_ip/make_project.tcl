create_project finn_vivado_stitch_proj /tmp/finn_dev_changhong/vivado_stitch_proj_j4oshdxh -part xczu7ev-ffvc1156-2-e
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_0__sw6ykf7 /tmp/finn_dev_changhong/code_gen_ipgen_Thresholding_rtl_0_zvohpeu9 /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_1_g5qe2_mx /tmp/finn_dev_changhong/code_gen_ipgen_MVAU_hls_0_spzpps40/project_MVAU_hls_0/sol1/impl/ip /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_2_zlnqauvb /tmp/finn_dev_changhong/code_gen_ipgen_MVAU_hls_1_bg1bfhnk/project_MVAU_hls_1/sol1/impl/ip /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_3_gipz1aj5 /tmp/finn_dev_changhong/code_gen_ipgen_MVAU_rtl_0_hfpg8958 /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_4_8gd6ifz2] [current_project]
update_ip_catalog
create_bd_design "finn_design"
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_0__sw6ykf7/Q_srl.v
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_0__sw6ykf7/StreamingFIFO_rtl_0.v
...
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_Thresholding_rtl_0_zvohpeu9/axilite.sv
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_Thresholding_rtl_0_zvohpeu9/thresholding.sv
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_Thresholding_rtl_0_zvohpeu9/thresholding_axi.sv
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_Thresholding_rtl_0_zvohpeu9/Thresholding_rtl_0.v
create_bd_cell -type module -reference Thresholding_rtl_0 Thresholding_rtl_0
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_1_g5qe2_mx/Q_srl.v
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_1_g5qe2_mx/StreamingFIFO_rtl_1.v
...
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_2_zlnqauvb/Q_srl.v
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_2_zlnqauvb/StreamingFIFO_rtl_2.v
...
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_3_gipz1aj5/Q_srl.v
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_3_gipz1aj5/StreamingFIFO_rtl_3.v
...
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_MVAU_rtl_0_hfpg8958/MVAU_rtl_0_wrapper.v
...
add_files -copy_to ./ip/verilog/rtl_ops/MVAU_rtl_0 -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_MVAU_rtl_0_hfpg8958/MVAU_rtl_0_memstream_wrapper.v
...
save_bd_design
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_4_8gd6ifz2/Q_srl.v
add_files -norecurse /tmp/finn_dev_changhong/code_gen_ipgen_StreamingFIFO_rtl_4_8gd6ifz2/StreamingFIFO_rtl_4.v
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_changhong/vivado_stitch_proj_j4oshdxh/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_changhong/vivado_stitch_proj_j4oshdxh/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_changhong/vivado_stitch_proj_j4oshdxh/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_changhong/vivado_stitch_proj_j4oshdxh/all_verilog_srcs.txt w]
